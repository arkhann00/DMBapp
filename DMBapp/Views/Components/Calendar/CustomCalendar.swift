        ...
        ZStack {
            ...
            VStack {
                HStack {
                    ...
                    Text("\(currentDate.getMonthYearString())")
                ...
                VStack {
                    HStack {
                        Text("ПН").frame(maxWidth: .infinity)
                        Text("ВТ").frame(maxWidth: .infinity)
                        Text("СР").frame(maxWidth: .infinity)
                        Text("ЧТ").frame(maxWidth: .infinity)
                        Text("ПТ").frame(maxWidth: .infinity)
                        Text("СБ").frame(maxWidth: .infinity)
                        Text("ВС").frame(maxWidth: .infinity)
                    }
                    .foregroundStyle(.black)
