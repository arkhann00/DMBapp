...
struct StatusView: View {
    ...
    var statuses = ["Солдат", "Офицер", "Курсант", "Я жду"]
            ...
            VStack {
                HStack{
                    ...
                    Button {
                        ...
                        Text(selectedStatus != nil ? "Далее".localize(language: viewModel.getLanguage()) : "Пропустить".localize(language: viewModel.getLanguage()))
                ...
                HStack {
                    Text("КТО ВЫ?".localize(language: viewModel.getLanguage()))
                        .foregroundStyle(.black)
                    ...
                    ForEach(0..<4) { num in
                        Button {
                            ...
                            ZStack{
                                ...
                                Text(statuses[num].localize(language: viewModel.getLanguage()))
