...
class SettingsViewModel: ViewModel {
    ...
    @Published var isBackgroundDim:Bool = false
    
    override init() {
        super.init()
        
        self.isBackgroundDim = userDefaults.bool(forKey: .isBackgroundDim) ?? false
    }
    ...
    func updateSettings() async {
        ...
        viewState = .loadingSavingSettings
    ...
    func removeBackground() async {
        if isAuthorizedUser() {
            viewState = .loadingRemoveBackgroundImage
